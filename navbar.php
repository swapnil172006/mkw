...
window.addEventListener('scroll', function() {
    ...
    if (currentScroll > 150) { // Starts hiding after scrolling down 150px
        if (currentScroll > lastScroll) {
            navElement.style.transform = "translateY(-100%)"; // Scrolling Down
        } else {
            navElement.style.transform = "translateY(0)"; // Scrolling Up
        }
    } else {
        navElement.style.transform = "translateY(0)"; // Near top
    }
